...
class MD5PasswordHasher implements IPasswordHasher
{
  ...
  protected function generateSalt()
  {
    if (function_exists("random_bytes")) {
      return base64_encode(random_bytes(self::SALT_BYTES));
    }
    if (function_exists("openssl_random_pseudo_bytes")) {
      return base64_encode(openssl_random_pseudo_bytes(self::SALT_BYTES));
    }
    throw new \Exception("generateSalt() was not able to generate random bytes");
  }
